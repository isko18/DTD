    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(max_length=100, verbose_name="Название лейбла"),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(max_length=100, verbose_name="Категория товара"),
                ),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "order_id",
                    models.CharField(
                        blank=True, max_length=10, unique=True, verbose_name="ID заказа"
                    ),
                ),
                (
                    "from_address",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="orders_from_label",
                        to="orders.label",
